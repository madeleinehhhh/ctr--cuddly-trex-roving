---
title: 'Christ the Reconciler'
description: 'A missional community of Protestants, Catholics, Eastern Orthodox, Pentecostals, and Jews seeking to live out John 17 in Elgin, Texas.'
layout: 'home.njk'
permalink: '/'
...
Christians have always disagreed. The faith is ancient, deep, and has traveled through every culture on earth. Disagreement is not the crisis.
...
- **Podcast Library** — Teachings on reconciliation, ecumenism, and Christian unity [[ctr-teachings-index|visit]]

---

%%SECTION: CREDENTIALING — trust signals for skeptics%%
...
> "Through prayer, fellowship and respectful dialogue we continue striving to respond to the prayer of our Lord Jesus that 'they may all be one.'"
>
...
[[ctr-about-friends|More commendations]]

---

%%SECTION: AUDIENCE PATHWAYS — helping each type of visitor self-identify%%

### Where Do You Fit?

**I'm curious and want to understand more.**

Start with who we are, what we believe, and how we got here.
...
**I want to follow along from a distance.**

Pray with us daily, listen to our teachings, and subscribe to the newsletter.

[[ctr-connect-index|Connect]]
...
_End of homepage copy_

---

### Editor Notes

- **Commendations on homepage**: Three quotes pulled directly — Dr. Rich Carney, Fr. René Constanza, and Sr. Joela Krüger. Together they cover Protestant/civic, Catholic, and international Lutheran — a strong spread. Adjust as needed.
- **"A rule and a way of life"** is now the organizing frame in the response section, replacing the old five-practices list. This gives the Statement equal weight with the practices and reflects the architecture more honestly.
- **The Statement pathway** is now its own audience pathway — because making the Statement is a distinct and important action that the old homepage never surfaced.
- **Nicene Creed reference removed** from orientation per earlier discussion — replaced with "rooted in the ancient Christian faith and accountable to recognized leaders across the traditions."
- **Location confirmed as Elgin, Texas** — appears in hero and orientation. Flag if this should be omitted for any reason.
- **"Passing Through Baca"**, **Wittenberg 2017**, **Cielo**, **Tiny Forge**: none appear on the homepage. They belong in History, Teachings, and Community pages respectively.
