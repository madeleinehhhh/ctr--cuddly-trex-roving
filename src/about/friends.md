...
These relationships are not endorsements of a program. They are the fruit of years of shared prayer, shared work, and shared commitment to the unity Jesus prayed for. They are also, frankly, a form of accountability: CTR is known by the company it keeps.

If you are wondering whether this community is trustworthy — whether it is rooted in orthodox Christian faith, connected to recognized leaders, and genuinely ecumenical rather than merely talking about ecumenism — this page is for you.
...
Those who gathered have become some of CTR's closest friends and most trusted voices.
...
>
> — Flora Ruiz, Roman Catholic, Los Angeles Archdiocese Pastoral Council, California
...
>
> — Walter Heidenreich, Pentecostal, Founder and President, FCJG and HELP International, Germany
...
>
> — Ben Girod Sr. and Benjamin Girod Jr., Amish, Montana
...
**Bruderhof** — [CONFIRM: one sentence description and nature of relationship]

**Antioch Network** — [CONFIRM: one sentence description and nature of relationship]

**IPECC** — [CONFIRM: expand acronym, one sentence description]

**ENC (European Network of Communities)** — [CONFIRM: confirm full name, one sentence description]

**Catholic Charismatic Communities** — CTR has longstanding friendships with Catholic Charismatic communities whose commitment to prayer and renewal has intersected significantly with CTR's own vocation.

**The Paulist Fathers** — Fr. René Constanza's commendation above reflects a friendship that has included partnership at the annual Lausanne Catholic-Evangelical dialogue in Chicago.

These relationships are not merely collegial. They are part of how CTR understands accountability — staying connected to recognized communities and leaders who can speak into the community's life and hold it to its commitments.
...
- **Commendation quotes**: All quotes are reproduced faithfully from the existing site. They should be verified against the originals before publication — some may have been given in writing, others verbally, and attribution should be accurate.
- **The Wittenberg 2017 paragraph**: The [CONFIRM] note needs a one-sentence answer about what the initiative produced. This appears in multiple places across the site and needs a consistent formulation.
- **The wider network section**: Four of the five entries need [CONFIRM] input from Thomas — full names, descriptions, and the nature of CTR's relationship with each. These are doing real credentialing work and need to be accurate.
- **Father Peter Hocken**: He appears in both the history page (visiting the Elgin property) and here as a commender. He was clearly a significant figure in CTR's network. If he has since passed away, the tense and framing of his commendation should be adjusted accordingly. [CONFIRM: Is Fr. Peter Hocken still living?]
- **Taizé comparison**: Dan Davis's commendation explicitly compares CTR to Taizé. This is the only place on the site where that comparison appears. Consider whether CTR wants to lean into it more explicitly elsewhere, or leave it as a commendation from someone else rather than a self-description.
- **Amish commenders**: Ben Girod Sr. and Benjamin Girod Jr. being Amish and from Montana is a remarkable detail — it signals the breadth of CTR's reach across traditions that rarely show up in ecumenical conversations. Worth making sure this is accurate and that they're comfortable being named publicly.
- **Photo opportunities**: Wittenberg 2017 photos, if available, would make this page significantly more compelling. A group photo from one of the gatherings would communicate the international, multi-traditional scope of the initiative better than any description.
