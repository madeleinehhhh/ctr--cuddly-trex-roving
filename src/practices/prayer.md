...
The Bridge Prayer is a bridge in two directions: it joins the members of CTR to each other across their traditions, and it joins CTR to Christians around the world who are praying for the same thing — the unity Jesus asked for.
...
This is not escapism. It is love. The community fans the flames of longing for Jesus' return because Jesus asked to be longed for — and because the unity of his people is intimately connected to that return. The Bride of Christ crying out "Come, Lord Jesus" is a Bride that has found her unity. Working toward that unity is working toward that cry.

Every Bridge Prayer ends with that longing expressed. It orients everything else.
...
- **The Bridge Prayer origin**: There is a significant [CONFIRM] here. The Bridge Prayer is referenced throughout the site as the daily heartbeat of CTR's prayer life, but I have no detail about its origin, authorship, structure, or whether it varies day to day. This page needs that information before it can be complete.
- **"Bridge" as a recurring metaphor**: The Bridge Prayer, the bridge over Cielo Creek, the Austin Bridge-Builders Association — "bridge" appears to be a significant metaphor in CTR's vocabulary. Worth being intentional about whether this is a deliberate theological frame or coincidental.
- **The longing for Jesus' return**: This section may be surprising to some visitors who associate this language with certain strands of evangelical eschatology. The framing here — longing as love, not escapism; unity as the condition of the cry — is careful. Make sure it reflects how the community actually talks about this.
- **Photo/audio opportunity**: This page would benefit from an embedded audio recording of the community praying the Bridge Prayer together — even a short clip. It communicates something text cannot.
